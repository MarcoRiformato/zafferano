          ...
          >
            <div class="px-4 py-2">
              ...
              <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Esplora il gusto unico dell'Elba in ogni sorso. Il tè allo zafferano Elbazaffè
                è una delicata miscela di tè verde e zafferano coltivato localmente per un'esperienza aromatica unica
              </p>
            </div>
            ...
            @mouseleave="imageUrl = '/images/elbazaffe.png'"
            ...
            <div class="flex items-center">
              ...
              <h1 class="text-lg font-bold text-white">€ 20</h1>
              <button
